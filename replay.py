...
def main() -> None:
    ...
    p.add_argument("--run-id", help="use this run id (live.py passes one so the followers know what to read)")
    a = p.parse_args()
    ...
    replay(a.date, a.symbols, at(a.start), at(a.end), a.speed, a.tick, a.late_fraction, a.late_delay, a.run_id)
